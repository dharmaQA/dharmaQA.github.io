# profilewebsite<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"  import="com.Eagle.Pojo.*" %>
...
-->
    ...
    <div id="video">
        ...
        <video autoplay muted loop id="myVideo">
          <source src="images/sarath-bg.mp4" type="video/mp4">
        </video>
            ...
            <div class="section animated-row" data-section="slide01">
                <div class="section-inner">
                    <div class="welcome-box">
                        ...
                        <h1 class="welcome-title animate" data-animate="fadeInUp">Sarath Jada</h1>
